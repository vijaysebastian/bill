                ...
                <h1>Email Verification</h2>
                    ...
                    <h1>Mobile Verification</h2>
                        ...
                        <div class="row" ng-show="showOTP">
                            ...
                            <div class="col-sm-4" style="margin: 5px"><button class="btn btn-info" ng-click="submitOTP(otp)" ng-disabled="otpbutton">Verify OTP</button><a  ng-click="resendOTP()" style="margin-left: 5px;line-height: 2.5;cursor: pointer">Resend OTP</a></div>
                        </div>
                        @endif
                        @endif
                        @if($user->role=='user')
